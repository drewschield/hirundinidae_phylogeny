...
# Set the working directory to current directory with input files
wd <- "./"
setwd(wd)
getwd()
...
plot(tr, cex = 0.6, no.margin = F, label.offset = 0.1); axisPhylo()
# write.tree(tr,file="./hirundinidae-all-rev1-95-prune2.tree")	# Optional: output tree after dropping P. sirintarae.
